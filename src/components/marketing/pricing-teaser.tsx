...
export function PricingTeaser() {
  return (
    <section id="pricing-teaser" className="border-t border-border/60 py-16 sm:py-20">
            ...
            <div
              ...
              className={
                p.popular
                  ...
                  : "relative rounded-2xl border border-border/60 bg-card p-5"
              }
            >
              {p.popular ? (
